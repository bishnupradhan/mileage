  ...
  <div class="container">
    ...
    <div class="row center-scr">
      <div class="span4 offset4 well">
        ...
        <?php endif; ?>        <?php echo form_open('login/register') ?>

        <input type="text" id="first_name" class="span4" name="first_name" placeholder="First Name" required>
        <input type="text" id="last_name" class="span4" name="last_name" placeholder="Last Name" required>
        ...
        <input type="password" id="cpassword" class="span4" name="cpassword" placeholder="Confirm Password" required>
